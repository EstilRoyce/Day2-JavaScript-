...
let num1=9.8
let parseFloat=Number(num1[Mathfloor(num1)])
...
let min=50
let max=100
let minMax=max - min + 1
let rand=Math.random(50,100) * minMax
let con=Math.floor(rand)+1
console.log(con)
...
let character=sent.lastIndexOf('because', 'because' ,'because')
console.log(sent.substring(characterI,character))
